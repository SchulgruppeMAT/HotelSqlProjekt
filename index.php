    ...
    <main>
        <header>
            ...
            <div class="container">
                ...
                <div id="1-bookingPopup" class="bookingPopup popupWindow is-hidden">
                ...
                <div class="booking-info bookingPopup" id="1-bookingPopup">
                    ...
                    <!-- hier kommt noch der bxSlider-->
                    <img class="sliderBX" src="x">

                    <form class="bookingPopupForm">
                        <label>Anreise<br><input type="date" name="come"></label><br>
                        <label>Abreise<br><input type="date" name="departure"></label><br>
                        <button name="booking" class="std-button">Buchen</button>
                    </form>
                </div>
            </div>
